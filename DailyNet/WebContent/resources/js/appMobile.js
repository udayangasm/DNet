...
var App = angular.module('myAppMobile',['ui.router', 'ngSanitize', 'ngMaterial','ngMessages']);
...
//	.state('filterAds', {
//		url:'/?category?district?less?more',
//		templateUrl: 'searchAds',
//		controller : "CategoryController as ctgController",
//		resolve: {
//			async: ['ItemService', '$stateParams', function(ItemService, $stateParams) {
//				return ItemService.filterAds($stateParams.category+'~'+$stateParams.district+'~'+$stateParams.less+'~'+$stateParams.more);
//   			}]
//        }
//	})
	.state('viewMore', {
...
//	.state('viewMoreDetailsRandom', {
//		url:'/{RandomID:[A-Za-z]{0,9}}',
//		templateUrl: 'viewMoreDetails',
//		controller : "viewMoreController as vMController",
//		resolve: {
//			async: ['ItemService', '$stateParams', function(ItemService, $stateParams) {
//				return ItemService.viewMore($stateParams.RandomID);
//   			}]
//        }
//	})
...
App.controller("viewMoreController", ['async','$scope', '$location', '$window', '$http', function(async,$scope, $location, $window, $http) {
	console.log("viewMoreController");
	var self = this;
	self.categories = async;
	console.log(self.categories);
	
	self.init = function(dlat,dlan) {
		initialize(dlat,dlan);
		initViewMoreSclider();
	}
